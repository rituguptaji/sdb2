	...
	<body>
		...
		<div id="show-word" class="content scaffold-show" role="main">
			...
			<ol class="property-list word">
				...
				<g:if test="${wordInstance?.author}">
				<li class="fieldcontain">
					<span id="author-label" class="property-label"><g:message code="word.author.label" default="Author" /></span>
					
						<span class="property-value" aria-labelledby="author-label"><g:fieldValue bean="${wordInstance}" field="author"/></span>
				...
				<g:if test="${wordInstance?.verifier}">
				<li class="fieldcontain">
					<span id="verifier-label" class="property-label"><g:message code="word.verifier.label" default="Verifier" /></span>
					
						<span class="property-value" aria-labelledby="verifier-label"><g:fieldValue bean="${wordInstance}" field="verifier"/></span>
