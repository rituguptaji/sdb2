...
<div class="fieldcontain ${hasErrors(bean: wordInstance, field: 'author', 'error')} ">
	<label for="author">
		<g:message code="word.author.label" default="Author" />
		
	</label>
	<g:textField name="author" value="${wordInstance?.author}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: wordInstance, field: 'verifier', 'error')} ">
	<label for="verifier">
		<g:message code="word.verifier.label" default="Verifier" />
		
	</label>
	<g:textField name="verifier" value="${wordInstance?.verifier}"/>
</div>
